  ...
  return (
    <main>
      ...
      <section className="hero">
        ...
        <h1>Help mathematical scrutiny become useful to the next reader.</h1>
        <p className="lede">
          ...
          Authors can request focused attention, and readers can contribute questions,
          partial attempts, and scoped checks with credit for their work.
        </p>
      </section>
      ...
      <section className="page-band" aria-labelledby="who-heading">
        ...
        <p className="page-prose">
          {site.maintainer_name ? (
            ...
            <>
              Significance is an independent project. The public repository is the
              current contact point; editorial entries identify their contributor.
            </>
          )}
        </p>
        <p className="page-prose">
      ...
      <section className="page-band" aria-labelledby="reach-heading">
        ...
        {site.contact_email ? (
          ...
          <p className="page-prose">
            Use the request page for questions about a record, or the public
            repository for project questions. Both routes use GitHub.
          </p>
        )}
        <p className="page-prose">
      ...
      <section className="page-band" aria-labelledby="editorial-heading">
        ...
        <p className="page-prose">
          ...
          machine, or inferred by whoever maintains this site. These labels describe where a statement comes from; they do not rank
          its reliability. Readers can inspect the reasoning and source behind it.
        </p>
      </section>
